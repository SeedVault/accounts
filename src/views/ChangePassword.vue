        ...
        <div class="card box">
          <div class="card-body">
            ...
            <div class="saving text-center mt-5 mb-5" v-show="saving || saved">
              <div v-bind:class="[{ 'load-complete mt-4 mb-4': saved }, 'circle-loader circle-text']">
                ...
                <form @submit.prevent="save" v-show="!saving">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-12">
                      <input-password v-model="currentPassword" id="password" :label="$t('profile.current_password')"
                      :placeholder="$t('profile.current_password_placeholder')" icon="outline-lock-24px@2x.svg"
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-12">
                      <input-password v-model="newPassword" id="newPassword" :label="$t('profile.new_password')"
                      :placeholder="$t('profile.new_password_placeholder')" icon="outline-lock-24px@2x.svg"
                      :validationErrors="validationErrors"></input-password>
                    </div>
                  </div>
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-12">
                      <input-password v-model="repeatNewPassword" id="repeatNewPassword" :label="$t('profile.repeat_new_password')"
                      :placeholder="$t('profile.repeat_new_password_placeholder')" icon="outline-lock-24px@2x.svg"
                      :validationErrors="validationErrors"></input-password>
                    </div>
                  </div>
